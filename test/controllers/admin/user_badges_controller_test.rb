...
class Admin::UserBadgesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'admin can sort assigned badges' do
    ...
    badge_a = Badge.create!(name: 'Alpha Badge', category: :special, level: :standard, image_name: 'a.png',
                            description: 'A')
    badge_z = Badge.create!(name: 'Omega Badge', category: :special, level: :standard, image_name: 'z.png',
                            description: 'Z')
