class CreateCustomSchema < ActiveRecord::Migration[7.1]
  def change
    ...
    create_table 'designers_lists', id: false, force: :cascade do |t|
      ...
      t.index %w[designer_id list_id], name: 'index_designers_lists_on_designer_id_and_list_id'
      t.index %w[list_id designer_id], name: 'index_designers_lists_on_list_id_and_designer_id'
    end
    ...
    create_table 'list_items', force: :cascade do |t|
      ...
      t.index %w[listable_type listable_id], name: 'index_list_items_on_listable'
    end
    ...
    create_table 'lists_references', id: false, force: :cascade do |t|
      ...
      t.index %w[list_id reference_id], name: 'index_lists_references_on_list_id_and_reference_id'
      t.index %w[reference_id list_id], name: 'index_lists_references_on_reference_id_and_list_id'
    end
